...
UIStartPlay::UIStartPlay()
{
	SetDate();
}

UIStartPlay::UIStartPlay(Vector2 pos, Vector2 size) :UIBase(pos, size)
{
	subUIDispF_ = false;
	subUi_ = -1;
	mousecount_ = 0;
...
void UIStartPlay::SetDate(void)
{
}

void UIStartPlay::Draw(void)
{
	Reset();
	...
	DrawFormatString(5, 15, 0xffffff, "スタート");
